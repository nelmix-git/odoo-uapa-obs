...
#         return super(AccountAccount, self)._check_recursion(cr, uid, ids, context)

#     def _check_type(self, cr, uid, ids, context=None):
#         return super(AccountAccount, self)._check_type(cr, uid, ids, context)

#     def _check_account_type(self, cr, uid, ids, context=None):
#         return super(AccountAccount, self)._check_account_type(cr, uid, ids, context)
