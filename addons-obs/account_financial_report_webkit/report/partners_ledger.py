...
class PartnersLedgerWebkit(report_sxw.rml_parse,
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        if initial_balance_mode == 'initial_balance':
            initial_balance_lines = self._compute_partners_initial_balances(
                accounts, subsidiary_ids, start_period, partner_filter=partner_ids,
                exclude_reconcile=False)

        ledger_lines = self._compute_partner_ledger_lines(
            accounts, subsidiary_ids, main_filter, target_move, start, stop,
        ...
        for subsidiary_id in subsidiary_ids:
            ledger_lines_dict[subsidiary_id] = {}
            init_balance[subsidiary_id] = {}
            partners_order[subsidiary_id] = {}
            for account in objects:
                ledger_lines_dict[subsidiary_id][account.id] = ledger_lines[subsidiary_id].get(account.id, {})
                init_balance[subsidiary_id][account.id] = initial_balance_lines[subsidiary_id].get(account.id, {})
                ...
                ledg_lines_pids = ledger_lines[subsidiary_id].get(account.id, {}).keys()
                if initial_balance_mode:
                    ...
                    init_balance[subsidiary_id][account.id] = {}
                    init_bal_lines_pids = []
    ...
    def _compute_partner_ledger_lines(self, accounts_ids, subsidiary_ids, main_filter,
        ...
        for subsidiary_id in subsidiary_ids:
            ...
            for acc_id in accounts_ids:
                move_line_ids = self.get_partners_move_lines_ids(
                    acc_id, subsidiary_id, main_filter, start, stop, target_move,
