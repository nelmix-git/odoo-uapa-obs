...
{
    'name': "BHD TXT File Generator",

    'summary': """
        Generacion Archivo TXT Nomina Banco BHD Leon
        """,

    'description': """
        Este modulo permite generar un archivo TXT para el envio de la nomina electronica al Banco BHD.
    """,
    ...
    'data': [
        ...
        'security/bhd_payroll_txt_file_security.xml',
