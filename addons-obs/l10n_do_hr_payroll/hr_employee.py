...
class EmployeeName(orm.Model):
    ...
    _auto = True
    _columns = {
    'names': fields.char('Primer y segundo nombre', size=128, required=True,
    help="""El primer y el segundo nombre del empleado."""),
    'first_lastname': fields.char('Primer apellido', size=64, required=True,
    help="""El primer apellido del empleado"""),
    'second_lastname': fields.char('Segundo Apellido', size=64,
    help="""El segundo apellido del empleado."""),
